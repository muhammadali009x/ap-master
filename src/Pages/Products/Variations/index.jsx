...
export default function Variation() {
    ...
    const lang_mode = useSelector(state => state.Languages.default.products.variations)
    return (
        <>
            <h3>{lang_mode.main_heading}</h3>
            <span>{lang_mode.sub_heading}</span>
            <Link to={{
                pathname: "/Products/Variations",
                search: `?AddVariations=true`,
            }}>
                {lang_mode.buttons[0]}
            </Link>
                        ...
                        return (
                            <tr className={classes.tableRow} key={ind}>
                                ...
                                <td colSpan="3">
                                    <Link
                                        to={{
                                            pathname: "/Products/Variation",
                                            search: `?EditVariation=true&variationId=${ind}`,
                                        }}>
                                    ...
                                    <Link
                                        to={{
                                            pathname: "/Products/Variation",
                                            search: `?DeleteVariation=true&variationId=${ind}`,
                                        }}>
